...
colif <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "Coliformes")
...
pe <- ggplot(data3, aes(x=Localidade, y=mean, fill=Parametro)) +
  ...
  theme(axis.title.y = element_blank(),
        axis.title.x = element_text(hjust=0.5, vjust=0.5, size = 30),
        axis.text.y = element_text(size = 30),
        axis.text.x= element_text( hjust=0.5, vjust=0.5, size = 30, angle = 45)) +
...
pc <- ggplot(data3, aes(x=Localidade, y=mean, fill=Parametro)) +
  ...
  geom_signif(inherit.aes = FALSE, data = STAT1, 
              aes(xmin=Group1, xmax=Group3, annotations=signif1, y_position=200000),
              manual = TRUE)+
  geom_signif(inherit.aes = FALSE, data = STAT2, 
              aes(xmin=Group2, xmax=Group4, annotations=signif2, y_position=190000),
              manual = TRUE)+
...
vibrio <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "vibrio")
...
pt <- ggplot(data4, aes(x=Localidade, y=mean, fill=Parametro)) +
  ...
  geom_errorbar(position=position_dodge(.9), width=.2, aes(ymin=mean-sem, ymax=mean+sem)) +
  geom_signif(inherit.aes = FALSE, data = STAT1, 
              aes(xmin=Group0, xmax=Group3, annotations=signif1, y_position=3000),
              manual = TRUE)+
  geom_signif(inherit.aes = FALSE, data = STAT2, 
              aes(xmin=Group2, xmax=Group4, annotations=signif2, y_position=2800),
              manual = TRUE)+
...
library(ggplot2)
# Basic box plot
fsqbox <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "tukey_fisico_quimicos")
metalbox <-read_excel("C:/Users/USER/Desktop/Marcelo_BIG/BOXPLOT.xlsx", sheet = "tukey_metais")

met <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "FSQ_metais")
bact <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "bact")
pb <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "pb")
p <-read_excel("C:/Users/USER/Desktop/SUBMISSAO BIG RIVERS/Marcelo_BIG/BOXPLOT.xlsx", sheet = "p")
...
graf <- ggplot(met, aes(x=Localidade, y=NMP, color=Parametro)) + 
  ...
  scale_y_continuous(limits = c(0, 0.45)) + theme_classic() + 
